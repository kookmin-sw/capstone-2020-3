...
var Windy = function( params ){
  var DEF_VELOCITY_SCALE = 1/20000;
  var VELOCITY_SCALE = DEF_VELOCITY_SCALE;  // scale for wind velocity (completely arbitrary--this value looks nice)
  var INTENSITY_SCALE_STEP = 150;            // step size of particle intensity color scale
...
*/
  ...
  var start = function( bounds, width, height, extent, zoom){
    ...
    if (zoom < 9)
      VELOCITY_SCALE = DEF_VELOCITY_SCALE;
    else if (zoom >= 9 && zoom < 14)
      VELOCITY_SCALE = DEF_VELOCITY_SCALE / (Math.pow(zoom, 1.5));
    else
      VELOCITY_SCALE = DEF_VELOCITY_SCALE / (Math.pow(zoom, 1.7));
    ...
    case 13:
      ...
      PARTICLE_LINE_WIDTH = 1.8;
      break;
    case 14:
      MOVING_SPEED=20;
      MAX_PARTICLE_AGE=20;
      PARTICLE_MULTIPLIER = 0.4;
      PARTICLE_LINE_WIDTH=2.5;
      break;
    case 15:
      MOVING_SPEED=30;
      MAX_PARTICLE_AGE=20;
...
/*    console.log("====================");
    ...
    //console.log("VELOCITY_SCALE=",VELOCITY_SCALE);
    console.log("MOVING_SPEED=",MOVING_SPEED);*/
